...
$dynamic("clone").Node = function(deep) {
...
$dynamic("get$innerHTML").SVGElement = function() {
  ...
  container.get$elements().addAll(clone.get$elements());
...
PureMVC_Dart.prototype.write = function(message) {
  get$$document().query("#status").set$innerHTML($add$($add$(get$$document().query("#status").get$innerHTML(), "<br/>"), message));
}
// ********** Code for top level **************
function main() {
