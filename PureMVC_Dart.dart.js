...
PureMVC_Dart.prototype.write = function(message) {
  html_get$document().query("#status").set$innerHTML($$add($$add(html_get$document().query("#status").get$innerHTML(), "<br/>"), message));
}
// ********** Code for top level **************
function main() {
...
(function(){
  ...
  var v4/*Uint8Array*/ = 'Uint8Array|Uint8ClampedArray';
  var v5/*CSSValueList*/ = 'CSSValueList|WebKitCSSTransformValue';
  var v6/*DOMTokenList*/ = 'DOMTokenList|DOMSettableTokenList';
  var v7/*EntrySync*/ = 'EntrySync|DirectoryEntrySync|FileEntrySync';
  var v8/*Node*/ = [v1/*CharacterData*/,v2/*Document*/,v3/*Element*/,'Node|Attr|DocumentFragment|ShadowRoot|DocumentType|Entity|EntityReference|Notation|ProcessingInstruction'].join('|');
  var v9/*HTMLCollection*/ = 'HTMLCollection|HTMLOptionsCollection';
  var table = [
    // [dynamic-dispatch-tag, tags of classes implementing dynamic-dispatch-tag]
    ['CSSValueList', v5/*CSSValueList*/]
    , ['CharacterData', v1/*CharacterData*/]
    , ['DOMTokenList', v6/*DOMTokenList*/]
