  ...
  _tests() {
    ...
    group('Facade::IFacade', () {
      test('getInstance()', () {
        ...
        final again = mvc.Facade.getInstance(multitonKey) as mvc.IFacade;
...
class FacadeTestMediator extends mvc.Mediator {
  ...
  FacadeTestViewComponent get vc {
    return viewComponent;
  }

  void set vc(FacadeTestViewComponent facadeTestViewComponent) {
    viewComponent = facadeTestViewComponent;
  }
  ...
  List<String> listNotificationInterests() {
    ...
    return [FacadeTestNotes.NOTE_1, FacadeTestNotes.NOTE_2, FacadeTestNotes.NOTE_3];
  }
