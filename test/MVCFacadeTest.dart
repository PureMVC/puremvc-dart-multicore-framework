  ...
  _tests() 
  {
    ...
    group('MVCFacade::IFacade', ()
    {
      test('getInstance()', () {
        ...
        IFacade again = MVCFacade.getInstance( multitonKey );
      ...
      test('getInstance(), hasCore()', () {
        ...
        Expect.isFalse( MVCFacade.hasCore( multitonKey ) );        
        
        // Get a unique multiton instance of Facade
        IFacade facade = MVCFacade.getInstance( multitonKey );
        
        // Make sure it's registered
        Expect.isTrue( MVCFacade.hasCore( multitonKey ) );        
      });
      ...
      test('removeCore(), hasCore()', () {
        ...
        // Make sure it's registered
        expect( MVCFacade.hasCore( multitonKey ), isTrue );        

        // Remove the core
        MVCFacade.removeCore(multitonKey);
        
        // Make sure the core is no longer registered
        expect( MVCFacade.hasCore( multitonKey ), isFalse );        
      });
    });
      
    // Test the Facade's IController interface functionality
    group('MVCFacade::IController', ()
    {
    ...
    group('MVCFacade::IView', ()
    {
      ...
      test('registerObserver(), notifyObserver()', () {
        ...
        IObserver observer = new MVCObserver( facadeTestMethod, this );
      ...
      test('registerMediator(), ->mediator.onRegister()', () {
        ...
        IMediator mediator = new FacadeTestMediator( vc );
        facade.registerMediator( mediator );
    ...
    group('MVCFacade::IModel', ()
    {
      ...
      test('registerProxy(), ->proxy.onRegister()', () {
        ...
        // Register a Proxy
        IProxy proxy = new FacadeTestProxy();
        facade.registerProxy( proxy );
...
void facadeTestMethod( INotification note ) {
...
class FacadeTestMediator extends MVCMediator
{
...
class FacadeTestProxy extends MVCProxy
{
...
class FacadeTestMacroCommand extends MVCMacroCommand 
{
...
class FacadeTestDoubleInputCommand extends MVCSimpleCommand
{
...
class FacadeTestSquareInputCommand extends MVCSimpleCommand
{
  void execute( INotification note ) 
  {
    // Get the VO from the note body
